...
State: `CN_SEARCH_SELECTION_EVENT_STATE_SPRINT2_PARTIALLY_COMPLETED` on the
...
flowchart LR
    ...
    EVENT["DEPRECATED<br/>EVENT_GENERATOR_NOT_OPERATIONAL<br/>zero Epoch-C budget"] -. "FORBIDDEN" .-> EPOCHC
...
- Temporal and state lanes add behaviour coverage outside static. Event is
  explicitly stopped after two failed real-support repairs.
...
- Epoch-D is not authorized because event/state independent matched-control
  economic increment was not established.
