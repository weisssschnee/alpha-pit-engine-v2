...
CANONICAL_CANDIDATE_FIELDS = [
    ...
    "paired_delta_day_uncertainty_contract",
    "paired_delta_day_aggregation_contract",
    "paired_delta_day_shared_block_indices",
    "paired_delta_day_uncertainty_seed",
    "paired_delta_day_count",
    "paired_delta_day_uncertainty_requested_iterations",
    "paired_delta_day_uncertainty_valid_iterations",
    "paired_delta_day_uncertainty_invalid_iterations",
    "paired_delta_day_uncertainty_valid_fraction",
    "paired_delta_day_uncertainty_expected_block_length",
    "paired_delta_day_observed_mean",
    "paired_delta_day_mean_p25",
    "paired_delta_day_support_mean_gt_0",
    "paired_delta_day_support_mcse",
    "paired_delta_day_minimum_support",
