...
def verify_authorization(path:Path,*,repo_root:Path|None=None)->dict[str,Any]:
 ...
 if schema==AUTHORIZATION_SCHEMA:
  ...
  if rc!={'recovery_kind':'INFRASTRUCTURE_PRE_EVALUATION_FAILURE','failed_target_run_id':'cn_program_base_event_tier_a_report_only_holdout_20260823_e69813c','failed_output_root':'D:\\ChengboRemote\\runtime\\cn_program_base_event_tier_a_report_only_holdout_20260823_e69813c','failed_admission_file_sha256':'f70f343822f87b1666719dc1905c140e0e17edb14cb4e6e03853907ac52d6375','recovery_scope':'SUBPROCESS_ENVIRONMENT_ONLY','fresh_output_root_required':True,'candidate_set_change_forbidden':True,'holdout_windows_change_forbidden':True,'endpoint_change_forbidden':True,'source_binding_change_forbidden':True}:raise ValueError('tier-a holdout recovery contract drift')
