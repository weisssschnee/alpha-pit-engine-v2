...
ROUTE_ID='cn-program-primitive-market-successor-v2'
CAMPAIGN_ID='CN_PROGRAM_PRIMITIVE_MARKET_SUCCESSOR_V2'
CAMPAIGN_PROFILE='cn_program_primitive_market_successor_v2'
AUTHORIZATION_SCHEMA='cn_program_primitive_market_successor_v2_authorization_v1'
AUTHORIZATION_RELATIVE_PATH=Path('runtime/run_plans/cn_program_primitive_market_successor_v2_authorization_v1.json')
...
def main(argv:Sequence[str]|None=None)->int:
 ...
 from scripts.run_cn_program_primitive_market_successor_v2 import run
