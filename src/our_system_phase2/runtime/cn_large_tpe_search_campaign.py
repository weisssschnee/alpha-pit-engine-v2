...
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX = dict(
    SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX
)
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_CHECKPOINTS = 1
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS = dict(
    CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX
)
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_COVERAGE_FLOORS = dict(
    CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS
)
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_FLEXIBLE_ALLOCATION = {
    route_id: 0 for route_id in ROUTES
}
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_RAW_ASKS = 1_152
CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_WALL_SECONDS = (
    12 * 60 * 60
)
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX = {
...
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_CHECKPOINTS = 1
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS = dict(
    SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX
)
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_COVERAGE_FLOORS = dict(
    SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS
)
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_FLEXIBLE_ALLOCATION = {
    route_id: 0 for route_id in ROUTES
}
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_RAW_ASKS = 768
SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_WALL_SECONDS = (
    12 * 60 * 60
)
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_MIX = {
...
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_MAXIMUM_CHECKPOINTS = 1
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_CAPS = dict(
    TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_MIX
)
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_COVERAGE_FLOORS = dict(
    TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_CAPS
)
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_FLEXIBLE_ALLOCATION = {
    route_id: 0 for route_id in ROUTES
}
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_MAXIMUM_RAW_ASKS = 184
TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_MAXIMUM_WALL_SECONDS = 6 * 60 * 60
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_MIX = {
    "SLOW_TEMPORAL_CHANGE": 24,
    "FIRSTN_PATH": 256,
    "SLOW_CROSS_SECTIONAL_LEVEL": 8,
    "MARKET_REGIME_CONDITION": 0,
    "DISCLOSURE_EVENT": 0,
}
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_MAXIMUM_CHECKPOINTS = 1
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_CAPS = dict(
    PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_MIX
)
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_COVERAGE_FLOORS = dict(
    PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_CAPS
)
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_FLEXIBLE_ALLOCATION = {
    route_id: 0 for route_id in ROUTES
}
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_MAXIMUM_RAW_ASKS = 288
PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_MAXIMUM_WALL_SECONDS = 6 * 60 * 60
...
def _campaign_runtime_spec(profile: str) -> dict[str, Any]:
    ...
    if str(profile) == CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_PROFILE:
        return {
            "campaign_profile": (
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_PROFILE
            ),
            "maximum_checkpoints": (
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_CHECKPOINTS
            ),
            "asks_per_checkpoint": sum(
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX.values()
            ),
            "maximum_raw_asks": (
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_RAW_ASKS
            ),
            "maximum_wall_seconds": (
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_WALL_SECONDS
            ),
            ...
            "coverage_floors": dict(
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_COVERAGE_FLOORS
            ),
            "route_formal_ask_caps": dict(
                CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS
            ),
            ...
            "minimum_required_fresh_exact_by_route": {
                route_id: int(math.ceil(count * FRESH_EXACT_MARGIN))
                for route_id, count in (
                    CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS.items()
                )
            },
        }
    if (
        ...
        return {
            ...
            "maximum_checkpoints": (
                SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_CHECKPOINTS
            ),
            "asks_per_checkpoint": sum(
                SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_MIX.values()
            ),
            "maximum_raw_asks": (
                SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_RAW_ASKS
            ),
            "maximum_wall_seconds": (
                SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_MAXIMUM_WALL_SECONDS
            ),
            ...
            "coverage_floors": dict(
                SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_COVERAGE_FLOORS
            ),
            "route_formal_ask_caps": dict(
                SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS
            ),
            ...
            "minimum_required_fresh_exact_by_route": {
                route_id: int(math.ceil(count * FRESH_EXACT_MARGIN))
                for route_id, count in (
                    SUPPLY_SAFE_CONTINUOUS_SHARED_CONTROL_WINNER_GUIDED_SEARCH_ROUTE_CAPS.items()
                )
            },
        }
    if str(profile) == TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_PROFILE:
        return {
            "campaign_profile": TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_PROFILE,
            "maximum_checkpoints": (
                TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_MAXIMUM_CHECKPOINTS
            ),
            "asks_per_checkpoint": sum(
                TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_MIX.values()
            ),
            "maximum_raw_asks": (
                TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_MAXIMUM_RAW_ASKS
            ),
            "maximum_wall_seconds": (
                TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_MAXIMUM_WALL_SECONDS
            ),
            "completion_mode": "FIXED_FORMAL_ASK_TRANCHE",
            "validation": "FORBIDDEN_DURING_AND_AFTER_TRANCHE",
            "fixed_route_mix": dict(
            ...
            "coverage_floors": dict(
                TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_COVERAGE_FLOORS
            ),
            "route_formal_ask_caps": dict(
                TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_CAPS
            ),
            ...
            "minimum_required_fresh_exact_by_route": {
                route_id: int(math.ceil(count * FRESH_EXACT_MARGIN))
                for route_id, count in (
                    TERMINAL_LIQUIDITY_SEARCH_CONTINUITY_ROUTE_CAPS.items()
                )
            },
        }
    if str(profile) == PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_PROFILE:
        return {
            "campaign_profile": (
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_PROFILE
            ),
            "maximum_checkpoints": (
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_MAXIMUM_CHECKPOINTS
            ),
            "asks_per_checkpoint": sum(
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_MIX.values()
            ),
            "maximum_raw_asks": (
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_MAXIMUM_RAW_ASKS
            ),
            "maximum_wall_seconds": (
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_MAXIMUM_WALL_SECONDS
            ),
            "completion_mode": "FIXED_FORMAL_ASK_TRANCHE",
            "validation": "FORBIDDEN_DURING_AND_AFTER_TRANCHE",
            "fixed_route_mix": dict(
            ...
            "coverage_floors": dict(
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_COVERAGE_FLOORS
            ),
            "route_formal_ask_caps": dict(
                PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_CAPS
            ),
            ...
            "minimum_required_fresh_exact_by_route": {
                route_id: int(math.ceil(count * FRESH_EXACT_MARGIN))
                for route_id, count in (
                    PRIMARY_ABSOLUTE_ECONOMIC_SEARCH_CONTINUITY_ROUTE_CAPS.items()
                )
            },
        }
