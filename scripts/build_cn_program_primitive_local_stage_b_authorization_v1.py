...
def build(repo: Path) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        ...
        "search_policy": {
            ...
            "stage_b_field_column_count": int(policy["stage_b_resource_preview"]["field_column_count"]),
            "stage_b_field_columns_sha256": str(policy["stage_b_resource_preview"]["field_columns_sha256"]),
        },
        "mechanism_prefreeze": {
        ...
        "resource_contract": {
            ...
            "resource_canary_field_column_count": int(policy["stage_b_resource_preview"]["field_column_count"]),
            "resource_canary_field_columns_sha256": str(policy["stage_b_resource_preview"]["field_columns_sha256"]),
