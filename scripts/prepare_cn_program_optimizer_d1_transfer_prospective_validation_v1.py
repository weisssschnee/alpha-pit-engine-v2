...
def _load_freeze(freeze_root: Path)->tuple[dict[str,Any],list[dict[str,Any]]]:
    ...
    if _sha256(members_path)!=str(freeze["candidate_members_file_sha256"]): raise RuntimeError("prospective validation members file drift")
