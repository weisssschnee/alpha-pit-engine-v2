...
def verify_plan(path:Path,*,repo_root:Path|None=None)->dict[str,Any]:
    ...
    if list(plan['validation_windows'])!=[dict(x) for x in d1.VALIDATION_WINDOWS]: raise RuntimeError('TIER_A_VALIDATION_WINDOW_DRIFT')
