...
ROUTES: dict[str, str] = {
    ...
    "cn-search-core-v2-production-wave3-v1": "our_system_phase2.runtime.cn_search_core_v2_production_wave3_v1",
    "cn-search-core-v2-production-wave4-v1": "our_system_phase2.runtime.cn_search_core_v2_production_wave4_v1",
    ...
    "cn-program-base-event-tier-a-report-only-holdout-v1": "our_system_phase2.runtime.cn_program_base_event_tier_a_report_only_holdout_v1",
...
HIGH_COST_ROUTE_ACTIONS: dict[str, frozenset[str]] = {
    ...
    "cn-search-core-v2-stage15-v1": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    "cn-search-core-v2-stage2-v1": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    ...
    "cn-search-core-v2-production-wave3-v1": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    "cn-search-core-v2-production-wave4-v1": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    ...
    "cn-program-primitive-market-successor-v1": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    "cn-program-primitive-market-successor-v2": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    "cn-program-primitive-market-successor-v3": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
    ...
    "cn-program-base-event-tier-a-report-only-holdout-v1": frozenset(
        {ACTION_LAUNCH, ACTION_RETRY}
    ),
