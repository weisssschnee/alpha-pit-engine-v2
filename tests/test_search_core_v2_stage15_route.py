...
def test_stage15_route_is_high_cost_and_authorization_bound():
    assert ROUTES[runtime.ROUTE_ID] == "our_system_phase2.runtime.cn_search_core_v2_stage15_v1"
    ...
    assert runtime.TOTAL_EVALUATIONS == 336
    assert runtime.TOTAL_PER_ARM == 168
