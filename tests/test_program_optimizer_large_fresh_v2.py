...
def test_large_fresh_v2_uses_realistic_24_worker_resource_canary() -> None:
    ...
    assert RESOURCE_CANARY_PREVIEW_FIELD_COLUMN_COUNT == 30
    assert RESOURCE_CANARY_PREVIEW_FIELD_COLUMNS_SHA256 == "5380b2f7e6bae58559cfde0685210bae2c3a149ad6b215b3a32b2eb34814f067"
    assert RESOURCE_CANARY_EFFECTIVE_FIELD_COLUMN_COUNT == 53
    assert RESOURCE_CANARY_EFFECTIVE_FIELD_COLUMNS_SHA256 == "3add1844a069d5c52a5a2dd1bc78f7c19b36c6892787a23fea7773818cca9950"
