...
def test_production_wave3_route_is_high_cost_and_authorization_bound():
    assert ROUTES[runtime.ROUTE_ID] == "our_system_phase2.runtime.cn_search_core_v2_production_wave3_v1"
